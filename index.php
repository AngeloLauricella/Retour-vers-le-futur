...
$destinationTime = new DateTime('2030-00-00 00:00:00');
...
echo "<br>";
echo "Sachant que la conso moyenne pour circuler dans le temps est de 0.1W /jour de voyage
, la Delorean a besoin de ". ($interval->days*0.1) . " 
Watt d'énergie pour arriver jusque là";